...
public class DatePicker extends CustomNode{
     ...
     public var date:GregorianCalendar = bind getDate(year,month,day);

     bound function getDate(year:Integer,month:Integer,day:Integer):GregorianCalendar{
                                ...
                                content:[
                                    ...
                                    XPicker {
                                              ...
                                              onIndexChange:function(index:Integer){
                                                  ...
                                                  daysInMonth =[1.. cal.getActualMaximum(Calendar.DAY_OF_MONTH)]
                                              }
                                    },
                                    XPicker {
                                              pickerType: XPickerType.DROP_DOWN
